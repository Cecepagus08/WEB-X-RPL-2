...
const Navbar = () => {
	...
	return (
		<>
			{/* Mobile */}
			<div className="flex justify-between relative top-9 lg:hidden">
				<div className="w-12 h-12 rounded-full flex justify-center items-center" id="UserButton">
					<img src="/NavIcon.png" alt="" className="w-8 h-8" onClick={toggleMenu} />
				</div>
				...
				<div className="w-12 h-12 rounded-full flex justify-center items-center" id="">
					<img src="/logoSMKN1.png" alt="" className="w-10 h-10" />
				</div>
				{isMenuOpen && (
