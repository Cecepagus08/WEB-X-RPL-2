					...
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="/logoRpl.png"
								alt=""
								className="h-[4rem] w-[4rem] right-2 relative rounded-full"
							/>
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/cecep_agus08/" class="hover:underline">
										CGS
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/official_smkn1palangkaraya?igsh=czBuaWF6ZnBvc2Nk" class="hover:underline ">
										Instagram
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X RPL 2 | Di Kelola Oleh Siswa X RPL 2
						</p>
					</div>
				</div>
			</div>
